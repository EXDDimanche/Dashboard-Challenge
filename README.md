...
For the KPI cards, channel, data source, and campaign tables, values were modeled after industry-standard benchmarks for CTR (typically between 8% and 12%), CPC, CPM, and conversion rates, ensuring the numbers feel realistic within a marketing context.
